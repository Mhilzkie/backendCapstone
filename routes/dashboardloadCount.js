...
const dashboardloadController = require('../controllers/dashboardloadCountController');
...
//     res.send(products);
// }
router.get('/',dashboardloadController.getproductCount)
// router.get('/',dashboardloadController.getuserCount)
